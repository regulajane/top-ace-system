		...
		<div class="container">
			...
			<div id="inventory">
				   ...
				   <div class="actionBtns">
						<button type="button" id="addnew" class="btn btn-primary" data-toggle="modal" 
							href="#addNewSupply"><i class="fa fa-plus fa-fw"></i> Add New Supply </button>
					
	           			 <div class="btn-group">
			                <a class="btn btn-primary" href="#"><i class="fa fa-folder-open"></i> Logs </a>
			                <a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#">
			                <span class="fa fa-caret-down"></span></a>
			                <ul class="dropdown-menu">
			                    <li><a type="button" class="btn btn-primary" href="" 
			...
			<div id="test1">
				<button type="button" id="addsupplybtn" class="btn btn-primary" data-toggle="modal" 
						href="#addInventoryModal" title="Add">
					<span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
				</button>
				<button type="button" id="procuresupplybtn" class="btn btn-primary" data-toggle="modal"
						title="Procure" href="#procSuppliesModal">
					<span class="glyphicon glyphicon-minus-sign" aria-hidden="true"></span>
				</button>
				<button type="button" id="deletesupplyBtn" class="btn btn-primary" data-toggle="modal"
