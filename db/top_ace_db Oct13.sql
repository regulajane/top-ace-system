...
INSERT INTO `clients` VALUES (1,'Francisco','Trisha','M','09068535509','Female','IC 77, Poblacion, La Trinidad, Benguet','2014-02-13'),(3,'Ferreria','Kimberly','R','09169212756','Female','17, Pias, Mapandan, Pangasinan','2013-10-10'),(4,'Salavatore','Perry','B','09196478953','Male','23, Quezon Hill, Baguio City','2013-10-10'),(5,'Apostol','Shirly','G','09124789624','Female','11, Poblacion, Sta. Barbara, Pangasinan','2015-10-10'),(6,'Corla','Elmo','F','09124796524','Male','01, New Lucban, Baguio City','2015-10-10'),(7,'Padlan','Karl','I','09153479562','Female','99, Honeymoon Road, Baguio City','2013-10-10'),(8,'Villanueva','Aizyl Grace','R','09354789210','Female','18, Malanay, Manaoag, Pangasinan','2015-10-10'),(9,'Mamucod','Rico','M','09163254896','Male','12, Trancoville, Baguio City','2014-02-13'),(10,'Alcid','Jovanni','Y','09306123945','Male','87, Golden, Moncada, Tarlac City','2014-02-13'),(11,'Lomboy','Kissel','E','09154652560','Female','34, Aurora Hill, Baguio City','2014-02-13');
...
INSERT INTO `employees` VALUES (1,'Snow','Jon','Stark','09061234567','Male','#3 Winterfell, Baguio City','Active','jonsnow@yahoo.com',3,'Machinist'),(2,'Tiong','Benedict','So','09121212121','Male','Baguio City, Benguet','Active','tiong@gmail.com',0,'Manager'),(3,'Tiong','Brenwin','So','09199829872','Male','Baguio City, Benguet','Active','tiongso@gmail.com',0,'Manager'),(4,'San Pedro','Marvin','Malik','09128718711','Male','Baguio City, Benguet','Active','marvin@gmail.com',1,'Machinist'),(5,'Castro','Jameson','Side','09182763871','Male','La Trinidad, Benguet','Active','castro@yahoo.com',1,'Machinist'),(6,'Conje','Noryza','Reyes','09912877126','Female','Sual, Pangasinan','Active','conje@gmail.com',0,'Front Desk Personnel'),(7,'Roces','Mikee','Ancheta','01216521982','Female','Dagupan, Pangasinan','Active','Roces@gmail.com',0,'Front Desk Personnel');
...
INSERT INTO `fabrications` VALUES (1,'Bronze Fabriction',25,500.00,'Pending',5);
...
INSERT INTO `joborders` VALUES (1,'P1','2015-10-10',NULL,NULL,NULL,500.00,1150.00,'Pending','Noryza Conje','8','2392932','Benedict Tiong','EngRecon',1),(2,'P2','2015-10-10',NULL,NULL,NULL,500.00,600.00,'Pending','Noryza Conje','6','343434','Brenwin Tiong','EngRecon',6),(3,'P1','2015-10-10',NULL,NULL,NULL,500.00,500.00,'Pending','Noryza Conje','15','4344343434','Benedict Tiong','EngRecon',6),(4,'P2','2015-10-11',NULL,NULL,NULL,500.00,2300.00,'Pending','Mikee Roces','14','348736478','Benedict Tiong','EngRecon',3),(5,'','2015-10-11','2015-10-11',NULL,NULL,500.00,500.00,'Pending','Mikee Roces',NULL,NULL,'Brenwin Tiong','Fabrication',1);
...
INSERT INTO `joemployees` VALUES (1,1),(3,1),(4,1),(4,4),(2,5);
...
INSERT INTO `servicelogs` VALUES (2,NULL,1,12),(3,NULL,1,5),(4,NULL,2,5),(5,NULL,3,4),(6,NULL,4,1),(7,NULL,4,16);
...
-- Dump completed on 2015-10-13 13:31:30
